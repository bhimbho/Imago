                ...
                <div class="card-body">
                    ...
                    <nav class="nav nav-pills flex-column flex-sm-row">
                      ...
                      <div class="row mt-3">
                            <div class="col-md-4">
                                <div class="card">
                                    <div class="card-body bg-warning">Image(s) Added ! ({{ 0 }})</div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card">
                                    <div class="card-body bg-dark text-white">Private Images ({{ 0 }})</div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card">
                                    <div class="card-body bg-warning">Public Images ({{ 0 }})</div>
                                </div>
                            </div>
                      </div>
                </div>
